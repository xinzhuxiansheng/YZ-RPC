package com.yzhou.rpc.core.registry.zk.util;

import com.yzhou.rpc.common.enums.RpcConfigEnum;
import com.yzhou.rpc.common.utils.PropertiesFileUtil;
...
public final class CuratorUtils {
    ...
    public static String ZK_REGISTER_ROOT_PATH = "/yz-rpc";
    ...
    public static void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            ...
            logger.error("create persistent node for path [{}] fail, message:{}", path, e);
        }
    }
    ...
    public static CuratorFramework getZkClient(String zkAddress) {
        ...
        if (StringUtils.isBlank(zkAddress)) {
            ...
            zookeeperAddress = properties != null && properties.getProperty(RpcConfigEnum.ZK_ADDRESS.getPropertyValue()) != null ? properties.getProperty(RpcConfigEnum.ZK_ADDRESS.getPropertyValue()) : DEFAULT_ZOOKEEPER_ADDRESS;
        } else {
